...
import { GalleryFeature } from "./gallery-feature";
import { AcademicWhyThisMatters } from "@/components/academic/academic-why-this-matters";
import { AcademicWhatWeBuilt } from "@/components/academic/academic-what-we-built";
import { AcademicStackArchitecture } from "@/components/academic/academic-stack-architecture";
import { AcademicRoadmapClosing } from "@/components/academic/academic-roadmap-closing";
...
export function StartPage() {
  ...
  return (
    <div className="fixed inset-0 bg-black">
      ...
      {/* Back button — links to Orchid main site */}
      <BackButton onClick={() => { window.location.href = "https://orchid.masudlewis.com"; }} />
      ...
      >
        ...
        {/* ─── Section 4b: Environmental Sensors ─── */}
        <div style={{ scrollSnapAlign: "start" }}>
          <SensorsFeature scrollRoot={scrollContainerRef} />
        </div>
        ...
        <div style={{ scrollSnapAlign: "start" }}>
          <GalleryFeature scrollRoot={scrollContainerRef} />
        </div>

        <div style={{ scrollSnapAlign: "start" }}>
          <AcademicWhyThisMatters scrollRoot={scrollContainerRef} />
        </div>

        <div style={{ scrollSnapAlign: "start" }}>
          <AcademicWhatWeBuilt scrollRoot={scrollContainerRef} />
        </div>

        <div style={{ scrollSnapAlign: "start" }}>
          <AcademicStackArchitecture scrollRoot={scrollContainerRef} />
        </div>

        <div style={{ scrollSnapAlign: "start" }}>
          <AcademicRoadmapClosing scrollRoot={scrollContainerRef} />
        </div>
      </div>
    </div>
  );
